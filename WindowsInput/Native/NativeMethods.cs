...
namespace WindowsInput.Native
{
    ...
    internal static class NativeMethods
    {
        ...
        /// <param name="dwhkl">Input locale identifier to use for translating the specified code.</param>
        ...
        /// An application can get the scan code corresponding to the left or right instance of one of these keys by calling MapVirtualKeyEx with uCode set to one of the following virtual-key code constants: VK_LSHIFT, VK_RSHIFT, VK_LCONTROL, VK_RCONTROL,VK_LMENU, VK_RMENU
        /// </remarks>
        [DllImport("user32.dll")]
